...
const CaseDetail = (props) => {
    ...
    return (
        <ContentContainer>
            ...
            <FlexBetweenView marginVertical={1}>
                <LeftTextContainer>
            ...
            {/* {!_.isEmpty(props.data.schedule) && (
                <WeekContainer>
                    <Week onPress={(ev, item) => handleWeekPress(ev, item)} />
                </WeekContainer>
            )} */}
            {/* {!_.isEmpty(props.data.schedule) && (
                <FlexBetweenView width={90} justifyContent="space-around">
                    <GrayText fontSize="16">9.00-11.00</GrayText>
                    <GrayText fontSize="16">Dr.Ronald</GrayText>
                </FlexBetweenView>
            )} */}
        </ContentContainer>
    );
